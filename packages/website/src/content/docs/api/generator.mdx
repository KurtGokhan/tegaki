...
The Tegaki generator processes fonts and outputs stroke data for handwriting animation. Use the [interactive generator](/generator/) on the Tegaki website to generate font bundles.
